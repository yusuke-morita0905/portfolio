...
const initialState: State = {
  ...
  about: `<p>1986年 東京都江戸川区生まれ。1児の父です。</p><p>2017年 職業訓練校WEB制作学科を卒業後、株式会社アートブルーに入社。アルバイトとして2年間、マークアップエンジニアに従事しました。</p><p>2019年 株式会社clamppyでフロントエンドエンジニアを担当しWordPressの構造やテーマ、プラグインについて理解を深める。自社メディア、士業系、美容系のサイト制作、コーディング、マークアップ、テーマ開発、プラグイン開発、保守等を担当しています。</p>`,
};
